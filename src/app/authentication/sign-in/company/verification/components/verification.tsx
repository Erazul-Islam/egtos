      ...
      <div className="flex-1 flex justify-center items-center px-4">
        <div className="bg-white w-full max-w-[892px] rounded-lg md:py-10 shadow-md md:pl-20 flex justify-center items-center">
          <div className="w-full">
            ...
            <SignInHeading className="text-center md:text-left" value="Enter Verification Code" />
            <HeadingDetails className="text-center md:text-left" value="We have sent a code to egtos@gmail.com" />
            ...
            <div className="my-5 md:pr-24 px-4 md:px-0 flex gap-4 md:my-10">
              ...
              <AuthButton
                onClick={() => router.push("/authentication/sign-in/company")}
