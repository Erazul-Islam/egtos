...
import { Completed, Progress, ProgressButton } from "@/app/authentication/components/progress";
      ...
      <div className="px-4 py-4">
        ...
        <div className="px-4 lg:px-16 my-6 md:my-12">
          ...
          <div className="my-5 flex gap-4 md:my-10">
            ...
            <AuthButton
              onClick={() =>
                router.push("/authentication/sign-in/consultation/verification")
              }
              href="/authentication/sign-in/consultation/verification"
              className="w-full"
              value="Continue"
            />
          </div>
